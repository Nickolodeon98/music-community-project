...
class CommentControllerTest {
  ...
  void success_write_comment() throws Exception {
    ...
    CommentResponse response = new CommentResponse(1L, 1L, "댓글", 100L, "이미지", "닉네임",
        LocalDateTime.now());
  ...
  void success_get_comment() throws Exception {
    CommentReadResponse response = new CommentReadResponse(1L, "chordpli", "image", "body", 100L, 1L,LocalDateTime.now());
  ...
  void success_get_all_comment() throws Exception {
    CommentReadResponse comment_01 = new CommentReadResponse(1L, "chordpli", "image", "body", 100L, 1L,
        LocalDateTime.now());
    CommentReadResponse comment_02 = new CommentReadResponse(2l, "chordpli2", "image2", "body2", 2L,
        200L, LocalDateTime.now());
    CommentReadResponse comment_03 = new CommentReadResponse(3l, "chordpli3", "image3", "body3", 3L,
