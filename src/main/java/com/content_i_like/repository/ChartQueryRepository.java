...
public class ChartQueryRepository {
  ...
  public List<RecommendChartResponse> getMonthlyRecommendChartTop10() throws Exception {
    return getRecommendChartByScore(12, 10);
  }
  ...
  public List<TrackChartResponse> getMonthlyTrackChartTop10() throws Exception {
    return getTrackChartByScore(12, 10);
  }
  ...
  List<RecommendChartResponse> getRecommendChartByScore(Integer expirationDateInWeeks,
      Integer limitSize) throws Exception {
...
//        .on(recommend.recommendNo.eq(comment.recommend.recommendNo))
  ...
  List<TrackChartResponse> getTrackChartByScore(Integer expirationDateInWeeks, Integer limitSize)
      throws Exception {
    ...
    List<Tuple> findChart = queryFactory
        ...
        .orderBy(recommend.recommendScore.desc(), recommend.track.trackTitle.asc(),
    ...
    for (Tuple tuple : findChart) {
      ...
      Long trackScore = Long.valueOf(String.valueOf(tuple.get(recommend.recommendScore)));
